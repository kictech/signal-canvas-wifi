...
![다각형 측정 구역 설정 완료 화면](docs/images/ui-step-boundary.png)

**그림 3. 다각형 측정 구역 설정 완료** — 84A 도면 위에 4개의 경계점을 지정한 예입니다. 경계점은 필요한 만큼 더 추가할 수 있습니다.
...
![SSID BSSID RSSI가 표시된 AP 선택 화면](docs/images/ui-step-wifi-ap.png)

**그림 4. AP 선택 화면** — SSID가 같더라도 BSSID를 함께 확인하고, 현재 RSSI와 채널을 기준으로 측정할 AP를 선택합니다. 화면의 AP 정보는 매뉴얼용 데모 데이터입니다.
...
![여러 RSSI 측정점으로 생성한 히트맵](docs/images/ui-step-heatmap.png)

**그림 5. RSSI 측정점과 IDW 히트맵** — `-42~-78 dBm`의 데모 측정점 6개를 사용한 결과입니다. 초록색은 상대적으로 강한 영역, 주황색은 약한 영역을 나타냅니다.

## 8. 결과 저장

![측정과 히트맵 생성이 완료된 전체 화면](docs/images/ui-step-complete.png)

**그림 6. 측정 완료 화면** — 다각형 경계, 공유기 위치, AP의 SSID·BSSID, RSSI 측정점, 히트맵과 결과 저장 버튼을 한 화면에서 확인할 수 있습니다.
